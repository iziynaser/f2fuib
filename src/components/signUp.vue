<template>
  <div>
    <b-form>
      ...
      <b-form-group id="confirmPassGroup" label-for="confirmPassword" :label="this.$t('SIGNUPFORM_confirmPassword')">
        <b-form-input id="confirmPassword" v-model="confirmPassword" type="password" required />
      </b-form-group>

      <b-form-group id="captchaGroup" label-for="captchaImg" :label="this.$t('SIGNUPFORM_captcha')">
        <b-img :src="captchaImg" id="captchaImg" fluid @click="doRefreshCaptcha" alt="captcha Image"></b-img>
      </b-form-group>
